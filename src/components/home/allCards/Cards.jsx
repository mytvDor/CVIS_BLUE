...
export default function Cards() {
  return (
    <>
      <div className="section mycardspace">
          ...
          <div className="card">
            ...
            <div className="card-content">
              ...
              <div className="card-text">
                ...
                operating system. This will help for business through mobile. It
                gives more value to your business using a mobile app for your
          ...
          <div className="card">
            ...
            <div className="card-content">
              ...
              <div className="card-text">
                ...
                provides a good user experience and helps your website visitors
