      ...
      <>
        ...
        <div className="container">
          ...
          <div className="text wblock">
            ...
            <h3>About</h3>
            <p>
              Graphic design is nothing but visual communication to communicate
              messages by attractive images. Client looking for images which
              show their business product in an effective manner. Graphic design
              is craft focus in displaying elements in design. Here we give your
              product a beautiful look in image by graphic design. We are best
              graphic designer in Kolhapur.
            </p>
