              ...
              <Tabs defaultActiveKey="tab1" tabPosition="left" className="tabs">
                <Tabs.TabPane tab="Lesson 1" key="tab1" className="tabheader">
                  <div className="content">
                    <h2>Lesson 1</h2>
                    <br />
                    This is your step description. Use this space to tell
                    participants how to complete this step. Include text and an
                    image or video to make your instructions interesting and
                    easy to understand. You can also imbed events, products and
                    more in the bottom formatting panel when creating the
                    step.Consider adding words of encouragement to keep
                    participants motivated to finish your program.
                  </div>
                </Tabs.TabPane>
